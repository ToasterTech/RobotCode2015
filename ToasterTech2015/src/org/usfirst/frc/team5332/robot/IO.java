...
public class IO {
	...
	public final static Solenoid intakeLeftPiston=new Solenoid(1); //Create IO references to the intake Solenoids
	...
	public final static Solenoid liftFlaps=new Solenoid(3); //Create IO references to the lift Solenoids
	public final static Solenoid liftLatch=new Solenoid(4);
	public final static DigitalInput liftMaxSwitch=new DigitalInput(1); //Create IO references to the DIO switches
	public final static DigitalInput liftMinSwitch=new DigitalInput(2);
