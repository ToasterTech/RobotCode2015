 ...
 * In this class, it is basically the same thing as AutoIntakeBin
 * Implements a Finite State Machine to determine what to do based on timer inputs. 
 */
public class IntakeAutoIntakeTote extends IntakeBehavior{
	...
	public IntakeAutoIntakeTote(){
		super();
		state=States.Start;
		timer=new Timer();
	}
	public IntakeAutoIntakeTote(IntakeLogic sw){
		super(sw);
		state=States.Start;
		timer=new Timer();
	}
