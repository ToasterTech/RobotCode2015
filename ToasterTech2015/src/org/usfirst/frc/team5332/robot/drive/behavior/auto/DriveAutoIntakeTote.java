 ...
 * 2.5 - 3.5: Turn right (drive left motor)
 * 3.5 - 4.4: Drive
 * 4.4: Stop driving
 */

/*
 * Auto behavior for intaking a tote, turning, and driving into the auto zone.
 * Basically the same as AutoIntakeBin, except changing the turn
 * Implements a Finite State Machine to determine what to do based on timer inputs. 
 */
public class DriveAutoIntakeTote extends DriveBehavior{
	...
	public DriveAutoIntakeTote(){
		super();
		state=States.Start;
		timer=new Timer();
	}
	public DriveAutoIntakeTote(DriveLogic sw){
		super(sw);
		state=States.Start;
		timer=new Timer();
	}
	...
	public void run(){
		...
		break;
		case Turn: logic.driveMotors(0.6, 0); state=States.Wait2; break;
